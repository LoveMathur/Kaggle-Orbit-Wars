"""
Orbit Wars — Competitive Agent v7
===================================
Critical Engineering Fixes after Replay Analysis:

1. FIXED THE 100-SHIP MAP EXIT: Restructured the loop so clamping occurs BEFORE 
                                trajectory prediction. The aiming angle is now 
                                perfectly synchronized with the exact fleet size.
2. BROKE THE REINFORCEMENT LOOP: Implemented a strict economic filter on reinforcements. 
                                  Planets will no longer ping-pong fleets back and forth.
3. CONSOLIDATED ALPHA STRIKES: Enforces that a planet must use its maximum speed capabilities 
                                rather than splitting payloads.
"""
